...
<div>
	...
	<div>  
		...
		<fieldset style="margin-top: 0" id="module_details">
			...
			<br/>
			<div class="clearfix <?php echo form_has_error('module_name') ? 'error' : ''; ?>">
			...
			<div class="clearfix mb_advanced <?php echo form_has_error('module_description') ? 'error' : ''; ?>">
			...
			<div class="clearfix mb_advanced">
				...
				<div class="input">
					<div class="inputs-list">
						<label for="db_required">
							...
							<?php echo lang('mb_form_generate'); ?>
						</label>
					</div>
				</div>
			</div>
		...
		<fieldset style="margin-top: 0" id="db_details">
			...
			<div class="clearfix mb_advanced <?php echo form_has_error('table_name') ? 'error' : ''; ?>">
			...
			<div class="clearfix mb_advanced <?php echo form_has_error('form_input_delimiters') ? 'error' : ''; ?>">
			...
			<div class="clearfix mb_advanced <?php echo form_has_error('form_error_delimiters') ? 'error' : ''; ?>">
			...
			<div class="clearfix mb_advanced <?php echo form_has_error('created_field') ? 'error' : ''; ?>">
			...
			<div class="clearfix mb_advanced <?php echo form_has_error('modified_field') ? 'error' : ''; ?>">
			...
			<div class="clearfix <?php echo form_has_error('primary_key_field') ? 'error' : ''; ?>">
		...
		for ($count = 1; $count <= $field_total; $count++) : // loop to build fields ?>
			...
			<div class="container <?php if ($count % 2): ?>left<?php endif;?>">  
				<fieldset id="field<?php echo $count; ?>_details">
					...
					<div class="clearfix <?php echo form_has_error("view_field_label{$count}") ? 'error' : ''; ?>">
					...
					<div class="clearfix <?php echo form_has_error("view_field_name{$count}") ? 'error' : ''; ?>">
					...
					<div class="clearfix <?php echo form_has_error("view_field_type{$count}") ? 'error' : ''; ?>">
					...
					<div class="clearfix <?php echo form_has_error("db_field_length_value{$count}") ? 'error' : ''; ?>">
